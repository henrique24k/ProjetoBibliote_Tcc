...
<body>
    <h3 style="text-align:center;">Acervo de Livros</h3>
    <?php
                ...
                while ($livro = mysqli_fetch_assoc($resultado)) {
                    ...
                    <div class="col-6">
                        <div class="card mb-3 p-3" style="max-width: 540px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="<?php echo $livro['nomeImagemLivro']; ?>" class="img-fluid rounded-start"
                                        alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title text-center">
                                            <?php echo $livro["tituloLivro"]; ?>
                                        </h5>
                                        <p class="card-text">
                                            <?php echo $livro["sinopseLivro"]; ?>
                                        </p>
                                        <!-- Button trigger modal -->
                                        <input type="submit" value="Reservar" class="btn btn-dark" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Reserva de livros
                                                        </h1>
